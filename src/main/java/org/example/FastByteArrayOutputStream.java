...
public final class FastByteArrayOutputStream extends OutputStream {
    ...
    public InputStream getInputStream() {
        return new EmbeddedInputStream(this);
    }
     ...
     * {@code FastByteArrayOutputStream}.
     */
    private static final class EmbeddedInputStream extends InputStream {
         ...
         * {@code FastByteArrayOutputStream}.
         */
        EmbeddedInputStream(FastByteArrayOutputStream fastByteArrayOutputStream) {
